...
import org.modula.parsing.definition.psi.impl.DefinitionProcedureDefinitionImpl;

import java.io.IOException;

/**
 * Implementation of {@link com.intellij.psi.stubs.IStubElementType} for generating {@link ProcedureStub}s from
 * {@link DefinitionProcedureDefinition}s and vice versa
 */
public class ProcedureStubElementType extends AbstractDefinitionStubElementType<ProcedureStub, DefinitionProcedureDefinition> {
	...
	@Override
	public DefinitionProcedureDefinition createPsi(@NotNull ProcedureStub stub) {
		return new DefinitionProcedureDefinitionImpl(stub, this);
	}

	@Override
	public ProcedureStub createStub(@NotNull DefinitionProcedureDefinition psi, StubElement parentStub) {
