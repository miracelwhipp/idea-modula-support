...
public class ModulaWhileStatementImpl extends ASTWrapperPsiElement implements ModulaWhileStatement {

  public ModulaWhileStatementImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof ModulaVisitor) ((ModulaVisitor)visitor).visitWhileStatement(this);
