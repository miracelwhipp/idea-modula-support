...
public class ModulaArrayRangeTypeImpl extends ASTWrapperPsiElement implements ModulaArrayRangeType {

  public ModulaArrayRangeTypeImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof ModulaVisitor) ((ModulaVisitor)visitor).visitArrayRangeType(this);
