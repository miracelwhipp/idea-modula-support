...
public class ModulaSetExpressionImpl extends ASTWrapperPsiElement implements ModulaSetExpression {

  public ModulaSetExpressionImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof ModulaVisitor) ((ModulaVisitor)visitor).visitSetExpression(this);
