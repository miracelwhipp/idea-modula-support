...
public class DefinitionSymbolImportClauseImpl extends ASTWrapperPsiElement implements DefinitionSymbolImportClause {

  public DefinitionSymbolImportClauseImpl(ASTNode node) {
    super(node);
  }
  ...
  public List<DefinitionImportSymbol> getImportSymbolList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, DefinitionImportSymbol.class);
  }
