...
public class DefinitionProcedureTypeDefinitionImpl extends ASTWrapperPsiElement implements DefinitionProcedureTypeDefinition {

  public DefinitionProcedureTypeDefinitionImpl(ASTNode node) {
    super(node);
  }
  ...
  public DefinitionParametersCommaSeparated getParametersCommaSeparated() {
    return findChildByClass(DefinitionParametersCommaSeparated.class);
  }
