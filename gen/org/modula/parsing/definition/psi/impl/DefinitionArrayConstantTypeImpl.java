...
public class DefinitionArrayConstantTypeImpl extends ASTWrapperPsiElement implements DefinitionArrayConstantType {

  public DefinitionArrayConstantTypeImpl(ASTNode node) {
    super(node);
  }
  ...
  public DefinitionArrayDeclaration getArrayDeclaration() {
    return findChildByClass(DefinitionArrayDeclaration.class);
  }
