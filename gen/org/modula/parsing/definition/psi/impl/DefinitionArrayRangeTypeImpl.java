...
public class DefinitionArrayRangeTypeImpl extends ASTWrapperPsiElement implements DefinitionArrayRangeType {

  public DefinitionArrayRangeTypeImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof DefinitionVisitor) ((DefinitionVisitor)visitor).visitArrayRangeType(this);
