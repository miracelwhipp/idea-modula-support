...
public class DefinitionStaticFieldImpl extends ASTWrapperPsiElement implements DefinitionStaticField {

  public DefinitionStaticFieldImpl(ASTNode node) {
    super(node);
  }
  ...
  public List<DefinitionFieldName> getFieldNameList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, DefinitionFieldName.class);
  }
