    ...
    public static PsiElement createElement(ASTNode node) {
      IElementType type = node.getElementType();
       if (type == ACTUAL_PARAMETERS) {
        return new DefinitionActualParametersImpl(node);
      }
      else if (type == ARRAY_RANGE_TYPE) {
        return new DefinitionArrayRangeTypeImpl(node);
      }
      else if (type == ARRAY_TYPE) {
        return new DefinitionArrayTypeImpl(node);
      }
        ...
        return new DefinitionBlockImpl(node);
      }
      else if (type == CASE_LABELS) {
        return new DefinitionCaseLabelsImpl(node);
      }
      else if (type == CASE_LABEL_LIST) {
        return new DefinitionCaseLabelListImpl(node);
      }
      else if (type == CASE_STATEMENT) {
        return new DefinitionCaseStatementImpl(node);
      }
      else if (type == CASE_STATEMENTS) {
        return new DefinitionCaseStatementsImpl(node);
      }
      else if (type == COMPLEX_LITERAL) {
        return new DefinitionComplexLiteralImpl(node);
      }
      else if (type == CONSTANT_DECLARATION) {
        return new DefinitionConstantDeclarationImpl(node);
      }
      else if (type == DECLARATION) {
        return new DefinitionDeclarationImpl(node);
      }
      else if (type == DEFINITIONS) {
        return new DefinitionDefinitionsImpl(node);
      }
      else if (type == DEFINITION_MODULE) {
        return new DefinitionDefinitionModuleImpl(node);
      }
        ...
        return new DefinitionExportClauseImpl(node);
      }
        ...
        return new DefinitionExpListImpl(node);
      }
      else if (type == FACTOR) {
        return new DefinitionFactorImpl(node);
      }
      else if (type == FIELD_LIST) {
        return new DefinitionFieldListImpl(node);
      }
      else if (type == FIELD_LIST_SEQUENCE) {
        return new DefinitionFieldListSequenceImpl(node);
      }
      else if (type == FORMAL_PARAMETERS) {
        return new DefinitionFormalParametersImpl(node);
      }
      else if (type == FORMAL_TYPE) {
        return new DefinitionFormalTypeImpl(node);
      }
      else if (type == FORMAL_TYPE_LIST) {
        return new DefinitionFormalTypeListImpl(node);
      }
      else if (type == FOR_STATEMENT) {
        return new DefinitionForStatementImpl(node);
      }
      else if (type == FP_SECTION) {
        return new DefinitionFPSectionImpl(node);
      }
      else if (type == IDENT) {
        return new DefinitionIdentImpl(node);
      }
      else if (type == IDENT_LIST) {
        return new DefinitionIdentListImpl(node);
      }
        ...
        return new DefinitionModuleDeclarationImpl(node);
      }
      else if (type == MODULE_HEADER) {
        return new DefinitionModuleHeaderImpl(node);
      }
        ...
        return new DefinitionRecordTypeImpl(node);
      }
        ...
        return new DefinitionSubRangeTypeImpl(node);
      }
        ...
        return new DefinitionTypesImpl(node);
      }
      else if (type == TYPE_DECLARATION) {
        return new DefinitionTypeDeclarationImpl(node);
      }
      else if (type == TYPE_DEFINITION) {
        return new DefinitionTypeDefinitionImpl(node);
      }
      else if (type == VARIABLE_DECLARATION) {
        return new DefinitionVariableDeclarationImpl(node);
      }
        ...
        return new DefinitionWhileStatementImpl(node);
      }
      else if (type == WITH_STATEMENT) {
        return new DefinitionWithStatementImpl(node);
      }
